  ...
  return (
    <div className={`review__container flex-container ${formIsOpen || 'review__closed'}`}>
      <section className='review'>
        <i onClick={handleExit} className='review__close bx bx-x'></i>
        <h2 className='review__title'>Rate your reserve</h2>
        <article className='review__reserve'>
          <header className='review__reserve-header'>
            <img className='review__reserve-image' src={bookSelected?.hotel.images[0].url} alt={bookSelected?.hotel.name} />
          </header>
          <div className='review__reserve-body'>
            ...
            <ul className='review__reserve-list'>
              ...
              <li className='review__reserve-item'>
                <span className='review__reserve-lable'>Reservation days:</span>
                <span>{reservationDays}</span>
              </li>
              <li className='review__reserve-item'>
                <span className='review__reserve-lable'>Subtotal price:</span>
